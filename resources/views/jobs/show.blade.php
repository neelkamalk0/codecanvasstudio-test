     ...
     <section class="md:col-span-3">
       ...
       <div class="container mx-auto p-4">
         ...
         <div x-data="{ open: false }" id="applicant-form">
          ...
          <div x-cloak x-show="open" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50 overflow-y-auto">
              <div @click.away="open = false" 
                  class="bg-white p-6 rounded-lg shadow-md w-full max-w-md mx-4 my-10 overflow-y-auto max-h-[90vh]">
                  ...
                  <form method="POST" action="{{route('applicant.store', $job->id)}}" enctype="multipart/form-data">
                      ...
                      <x-inputs.file id="resume_path" name="resume_path" label="Upload Your Resume (pdf)" :required="true" />
